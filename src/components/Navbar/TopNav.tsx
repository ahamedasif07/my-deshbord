...
export default function Navbar() {
  ...
  return (
    <div className="pb-6 ">
      <div
        className={`fixed top-0 z-50 h-16 transition-all duration-300 
    ${
      isSideBarOpen
        ? "md:ml-64 ml-[200px] md:w-[calc(100%-16rem)] w-[calc(100%-200px)]"
        : "ml-0 w-full"
    }`}
      >
        <nav
        ...
        >
          ...
          <div className="flex items-center gap-y-2 ">
            ...
            <div className="hidden md:block">
              <div className="flex items-center  gap-[5px] sm:gap-[8px] md:gap-4">
                {/* Icons */}
